...
## S9D.1 — Preprocessor Façade Struct
...
#### S9D.1.1 — Add Delegation-Focused Tests
...
#### S9D.1.2 — Introduce `Preprocessor` Struct and Constructor
...
#### S9D.1.3 — Preserve Package-Level Wrapper Entrypoints
...
#### S9D.1.4 — Remove `sharedLogger` Package-Level Variable
...
#### S9D.1.5 — Verify Preprocessor Behavior Parity
...
#### S9D.2.1 — Lock Current Composer Ordering with Tests
...
#### S9D.2.2 — Introduce `Composer` Struct and Constructor
...
#### S9D.2.3 — Keep Helper Boundaries Local
...
#### S9D.2.4 — Preserve the Existing Package Entrypoint
...
#### S9D.2.5 — Verify Composer Regressions
Legacy - Run `go test ./internal/composer -v`
- Re-run `go test ./...` after all S9D.2 changes land

---

## S9D.3 — Clean Up Analyzer Dual API Pattern
...
#### S9D.3.1 — Consolidate DepGraphBuilder
...
#### S9D.3.2 — Flesh Out ImpactAnalyzer
