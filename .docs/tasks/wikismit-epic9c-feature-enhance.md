...
## S9C.1 — Extend NavPlan with Architecture Summary
...
#### S9C.1.1 — Define ArchSummary Structure
...
#### S9C.1.3 — Validate Architecture Summary Output
...
#### S9C.1.4 — Verify Planner Produces Architecture Summary
...
## S9C.2 — Inject Cross-Module Context into Agent Prompts
...
#### S9C.2.1 — Extend AgentInput Structure
...
#### S9C.2.2 — Inject Architecture Context into Agent Prompt
...
#### S9C.2.3 — Wire Architecture Context through Pipeline
...
#### S9C.2.4 — Verify Agent Prompt Quality
...
## S9C.3 — Generate Architecture Overview Page
...
#### S9C.3.1 — Add Architecture Page Template Test
...
#### S9C.3.2 — Implement `generateArchitecturePage`
...
**Acceptance criteria:**
- All focused tests for S9C.1, S9C.2, S9C.3 pass
